...
# Resources
az deployment group create --resource-group $RG --template-file .\deployment\iac.bicep --parameters environment=$ENVIRONMENT projectName=$PROJECT_NAME sqlserver_user=$SQLSERVER_USER sqlserver_password=$SQLSERVER_PASSWORD
