...
var service_bus_ReadPolicy_name = 'ReadPolicy'
var service_bus_WritePolicy_name = 'WritePolicy'

var db_connection_string_env_var_name = 'TestTemplate2DbConnection'
...
resource sqlserver 'Microsoft.Sql/servers@2022-11-01-preview' = {
  ...
  location: location
  properties: {
    administratorLogin: sqlserver_user
    administratorLoginPassword: sqlserver_password
    version: '12.0'
...
resource app_service_appsetting 'Microsoft.Web/sites/config@2022-09-01' = {
  ...
  properties: {
    ...
    alwaysOn: false
    appCommandLine: 'dotnet TestTemplate2.Api.dll'
...
resource service_bus 'Microsoft.ServiceBus/namespaces@2021-06-01-preview' = {
  ...
  resource service_bus_ReadPolicy 'authorizationrules@2022-10-01-preview' = {
    name: service_bus_ReadPolicy_name
    properties: {
      rights: [
        'Manage'
        'Listen'
