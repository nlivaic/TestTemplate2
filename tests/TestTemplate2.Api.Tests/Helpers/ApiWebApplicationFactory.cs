        ...
        IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.Remove(services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<TestTemplate2DbContext>)));
                ...
                var ctx = scopedServices.GetRequiredService<TestTemplate2DbContext>();
        ...
        public TestTemplate2DbContext CreateDbContext(ITestOutputHelper testOutput = null)
        {
        ...
        {
            private readonly DbContextOptions<TestTemplate2DbContext> _options;
            ...
            {
                _options = new DbContextOptionsBuilder<TestTemplate2DbContext>()
            ...
            public TestTemplate2DbContext BuildContext() =>
                new(_options);
        }
    }
}
