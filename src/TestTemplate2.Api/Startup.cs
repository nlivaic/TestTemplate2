...
using TestTemplate2.Api.Helpers;
using TestTemplate2.Api.Middlewares;
using TestTemplate2.Application;
using TestTemplate2.Common.MessageBroker;
using TestTemplate2.Core;
using TestTemplate2.Data;

namespace TestTemplate2.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TestTemplate2DbContext>(options =>
            {
                var connString = new SqlConnectionStringBuilder(_configuration.GetConnectionString("TestTemplate2DbConnection") ?? string.Empty)
                {
            ...
            services.AddSwaggerGen(setupAction =>
            {
                setupAction.SwaggerDoc(
                    "TestTemplate2OpenAPISpecification",
                    new OpenApiInfo
                    {
                        Title = "TestTemplate2 API",
                        Version = "v1",
                        Description = "This API allows access to TestTemplate2.",
                ...
                setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestTemplate2.Api.xml"));
            });
            ...
            services.AddCors(o => o.AddPolicy("TestTemplate2Client", builder =>
            {
            ...
            services.AddMassTransit(x =>
            {
                ...
                x.AddEntityFrameworkOutbox<TestTemplate2DbContext>(o =>
                {
            ...
            services.AddTestTemplate2ApplicationHandlers();
            ...
            services
                .AddHealthChecks()
                .AddDbContextCheck<TestTemplate2DbContext>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //    app.UseHsts();
            // }
            app.UseCors("TestTemplate2Client");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/TestTemplate2OpenAPISpecification/swagger.json", "TestTemplate2 API");
