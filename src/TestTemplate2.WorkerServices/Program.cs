...
using TestTemplate2.Common.MessageBroker.Middlewares.ErrorLogging;
using TestTemplate2.Common.MessageBroker.Middlewares.Tracing;
using TestTemplate2.Core;
using TestTemplate2.Core.Events;
using TestTemplate2.Data;
using TestTemplate2.WorkerServices.FaultService;
using TestTemplate2.WorkerServices.FooService;
...
namespace TestTemplate2.WorkerServices
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                Log.Information("Starting up TestTemplate2 Worker Services.");
            ...
            {
                Log.Fatal(ex, "TestTemplate2 Worker Services failed at startup.");
            }
            finally
            {
                Log.CloseAndFlush();
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    {
                        var connString = new SqlConnectionStringBuilder(configuration.GetConnectionString("TestTemplate2DbConnection"))
                        {
